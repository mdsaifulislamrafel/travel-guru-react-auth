            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
                ...
                <form action="" className="space-y-6">
                    <div className="space-y-2 text-sm">
                        ...
                        <input type="text" name="FirstName" id="username" placeholder="First Name" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                    </div>
                    <div className="space-y-2 text-sm">
                        <label htmlFor="username" className="block ">
                            Last Name
                        </label>
                        <input type="text" name="LastName" id="username" placeholder="Last Name" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                    </div>
                    <div className="space-y-2 text-sm">
                        <label htmlFor="username" className="block ">
                            Username or Email
                        </label>
                        <input type="text" name="UsernameOrEmail" id="username" placeholder="Username or Email" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                    </div>
                    <div className="space-y-2 text-sm">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <input type="password" name="ConfirmPassword" id="password" placeholder="Confirm Password" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
