        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-10">
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white font-sans mx-auto">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <input {...register("firstName", { required: true })} type="text" name="firstName" id="firstname" placeholder="First Name" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring" />
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <input {...register("lastName", { required: true })} type="text" name="lastName" id="lastname" placeholder="Last Name" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring" />
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button onClick={() => handleFacebookLogin()} aria-label="Log in with Twitter" className="p-3 rounded-full hover:bg-gray-200">
